...
public class LSTMCharModellingExample {
    public static void main( String[] args ) throws Exception {
        int lstmLayerSize = 512;					//Number of units in each LSTM layersmile
    ...
    public static CharacterIterator getShakespeareIterator(int miniBatchSize, int sequenceLength) throws Exception{
        ...
        fileLocation = "d:\\projects\\souteneur\\rus_wikipedia_2010_1M-sentences.txt";
        ...
        char[] validCharacters = new RussianCharacters().chars();	//Which characters are allowed? Others will be removed
